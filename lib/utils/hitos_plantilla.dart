...
class HitosTramo {
  ...
  String get titulo => 'Hitos $meses meses';
}
...
class HitosPlantilla {
  ...
  static const List<HitosTramo> tramos = [
    HitosTramo(3, [
      HitosArea('Desarrollo Motor Grueso', [
      ...
      HitosArea('Desarrollo Motor Fino', [
      ...
      HitosArea('Desarrollo Cognitivo', [
      ...
      HitosArea('Lenguaje y Comunicación', [
      ...
      HitosArea('Socialización y Autoayuda (Autonomía)', [
